...
class MemoryLocation(Atom):
    ...
    def __init__(self, addr: Union[SpOffset,HeapAddress,int,claripy.ast.BV], size: int, endness: Optional[str]=None):
        """
        ...
        self.addr: Union[SpOffset,int,claripy.ast.BV,HeapAddress] = addr
        self._size: int = size

...
typedef __uint128_t biguint_t;
typedef __uint128_t seq_t;
...
int syscallname2id(std::string syscall_name);
...
public:
	...
	std::unordered_map <std::string, SyscallType_t> syscall_map;

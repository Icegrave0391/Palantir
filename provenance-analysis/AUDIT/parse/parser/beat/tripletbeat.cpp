...
Triplet::Triplet(const Json::Value &_event, KG* _infotbl): event(_event) {
	...
	syscallMap["pread"] = SyscallType_t::Pread;
	syscallMap["write"] = SyscallType_t::Write;
	syscallMap["writev"] = SyscallType_t::Writev;
	...
	syscallMap["accept4"] = SyscallType_t::Accept4;
	syscallMap["accept"] = SyscallType_t::Accept4;
}
...
void Triplet::Event2triplet() {
	...
	// std::cout << uint128tostring(Jval2int(event["auditd"]["sequence"])) << std::endl;
...
void Triplet::SyscallRead() {
	...
	if (f == NULL) {
		...
		KGEdge *e = new KGEdge (s_id_ptr, p_id_ptr, EdgeType_t::Read, seq, sess, timestamp);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*s_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
...
void Triplet::SyscallPread() {
	...
	if (f == NULL) {
		...
		hash_t *s_id_ptr = s->id;
		// KGEdge *e = new KGEdge (s_id_ptr, p_id_ptr, EdgeType_t::Recv, seq, sess, timestamp);
		KGEdge *e = new KGEdge (s_id_ptr, p_id_ptr, EdgeType_t::Pread, seq, sess, timestamp);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*s_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
		...
		hash_t *f_id_ptr = f->id;
		KGEdge *e = new KGEdge (f_id_ptr, p_id_ptr, EdgeType_t::Pread, seq, sess, timestamp);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*f_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
...
void Triplet::SyscallWrite() {
	...
	sess_t sess = std::stoi(Jval2str(event["auditd"]["session"]));
	std::string timestamp = Jval2str(event["@timestamp"]);
	std::string pt = Jval2str(event["auditd"]["pt"]);
	...
	if (f == NULL) {
		...
		KGEdge *e = new KGEdge (p_id_ptr, s_id_ptr, EdgeType_t::Write, seq, sess, timestamp, pt);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*s_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
		...
		hash_t *f_id_ptr = f->id;
		KGEdge *e = new KGEdge (p_id_ptr, f_id_ptr, EdgeType_t::Write, seq, sess, timestamp, pt);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*f_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
...
void Triplet::SyscallWritev() {
	...
	if (f == NULL) {
		...
		hash_t *s_id_ptr = s->id;
		// KGEdge *e = new KGEdge (p_id_ptr, s_id_ptr, EdgeType_t::Send, seq, sess, timestamp);
		KGEdge *e = new KGEdge (p_id_ptr, s_id_ptr, EdgeType_t::Writev, seq, sess, timestamp, pt);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*s_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
		...
		hash_t *f_id_ptr = f->id;
		KGEdge *e = new KGEdge (p_id_ptr, f_id_ptr, EdgeType_t::Writev, seq, sess, timestamp, pt);
		infotbl->InsertEdge(e);
		infotbl->InsertFileInteraction(*f_id_ptr, e);
		infotbl->InsertProcInteraction(*p_id_ptr, e);
	}
...
void Triplet::SyscallAccept4() {	
	...
	// KGEdge *e = new KGEdge (p_id_ptr, f_id_ptr, EdgeType_t::Accept4, seq, sess, timestamp);
	// infotbl->InsertEdge(e);
}
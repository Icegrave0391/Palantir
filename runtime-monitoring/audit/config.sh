...
ps -ef | grep -E 'gnome|xorg|ibus|vmtool|gvfs|nautilus|dbus|avahi|zeitgeist|compiz|NetworkManager|x86_64-linux-gnu|upstart|bash|vscode' | grep -v 'gnome-terminal' | awk '{print $2}' | python proc_filter.py >> $audit_rule_path
